...
### Housekeeping
- `A.6.1.1.1.2.6.2.1.2` (Active Instances Directory): removed `Junior`
- `A.6.1.1.1.2.6.2.1.3` (Completed Instances Directory): removed `Junior`
- `A.6.1.1.1.2.6.2.1.4` (In Progress Invocations Directory): removed `Junior`
- `A.6.1.1.1.2.6.2.1.5.1.1` (Failed Invocations): removed `Junior`
- `A.6.1.1.1.2.6.2.1.5.1.2` (Suspended Instances): removed `Junior`
- `A.6.1.1.1.2.6.2.1.5.1` (Archived Invocations/Instances): removed `Junior`
- `A.6.1.1.1.2.6.2.1` (Primitive Hub Document): removed `Junior`
- `A.6.1.1.1.2.6.2.2` (Active Instances): removed `Junior`
- `A.6.1.1.1.2.6.2.3` (Completed Instances): removed `Junior`
- `A.6.1.1.1.2.6.2.4` (In Progress Invocations): removed `Junior`
- `A.6.1.1.1.2.6.2` (Risk Capital Rental Primitive): removed `Junior`
